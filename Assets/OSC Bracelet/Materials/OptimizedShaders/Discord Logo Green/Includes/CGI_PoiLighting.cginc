...
UnityIndirect CreateIndirectLight(float3 normal)
{
    ...
    indirectLight.specular = 0;
        ...
        indirectLight.diffuse = max(indirectLight.diffuse, float(0.3));
                ...
                switch(float(0))
                {
                    ...
                    case 2: // or wrapped
                    {
                        ...
                        if (float(0.3) > 0)
                        {
                            ...
                            finalLighting = max(poiLight.finalLighting, poiLight.finalLighting / max(0.0001, (finalluminance / float(0.3))));
