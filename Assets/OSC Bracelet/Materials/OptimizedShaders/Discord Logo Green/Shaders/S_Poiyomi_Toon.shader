Shader "Hidden/Locked/.poiyomi/• Poiyomi Toon •/Discord Logo Green-Discord Logo Green"
{
    Properties
    {
...
#define PROP_LIGHTINGMINLIGHTBRIGHTNESS 0.3
...
#define PROP_MATCAPREPLACE 0.092
...
#define PROP_EMISSIONSTRENGTH 0.8
