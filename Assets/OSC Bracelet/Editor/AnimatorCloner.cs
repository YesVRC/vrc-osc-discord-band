...
namespace Shadoki
{
    // Taken from https://github.com/VRLabs/Avatars-3.0-Manager
    public static class AnimatorCloner
    {

        public const string STANDARD_NEW_ANIMATOR_FOLDER = "Assets/OSC Bracelet/Animations/";
        public const string STANDARD_NEW_PARAMASSET_FOLDER = "Assets/OSC Bracelet/Animations/";
        public const string STANDARD_NEW_MENUASSET_FOLDER = "Assets/OSC Bracelet/Animations/";
